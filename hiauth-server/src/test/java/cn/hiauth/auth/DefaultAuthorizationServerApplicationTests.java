...
public class DefaultAuthorizationServerApplicationTests {
	private static final String REDIRECT_URI = "http://127.0.0.1:8081/authorize/oauth2/code/hiauth-authorization-code";
	...
	public void whenLoggingInAndRequestingTokenThenRedirectsToClientApplication() throws IOException {
		...
		signIn(this.webClient.getPage("/login"), "pwd", "test", "123456");

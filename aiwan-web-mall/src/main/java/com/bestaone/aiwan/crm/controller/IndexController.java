...
public class IndexController {
	...
	private static final String GET_GOODS_URL = "http://localhost:9080/api/goods";

	private static final String PROFILE_URL = "http://localhost:9081/api/user/profile";
...
//		getMyLog(model, aiwanApi, accessToken);
		getMyGoods(model, aiwanApi, accessToken);
...
//	}
	...
	private void getMyGoods(Model model, final OAuth20Service aiwanApi, OAuth2AccessToken accessToken) throws Exception {
		OAuthRequest apiRequest = new OAuthRequest(Verb.GET, GET_GOODS_URL + "?pageNum=1&pageSize=10");
		aiwanApi.signRequest(accessToken, apiRequest);
